$.fn.pcodedmenu = function(e) {
    var t = this.attr("id"),
        ...
        o = {
            ...
            HandleVerticalScrollbar: function() {
                "vertical" === e.themelayout && (satnt = e.defaultVerticalMenu.desktop, "expanded" !== satnt && "compact" !== satnt || (mt = e.MenuTrigger, "click" === mt && $("#mobile-collapse,#mobile-collapse1").click(function(e) {
                    ...
                    rel = t.attr("rel"), el = $(".pcoded-navbar"), "collapsed" == $("#pcoded").attr("vertical-nav-type") ? ($(".main-menu").slimScroll({
                        destroy: !0
                    }), $(".main-menu").css("overflow", "visible"), $("body").addClass("menucollapse")) : ($("body").removeClass("menucollapse"), $(".main-menu").slimScroll({
            ...
            Handlemenutype: function() {
                var a = e.menutype,
                    o = (e.freamtype, e.NavbarImage),
                    i = e.ActiveNavbarImage;
                void 0 != a && "" != a ? $("#" + t).attr("nav-type", a) : $("#" + t).attr("nav-type", "st1"), void 0 != o && "" != o ? $("#" + t).attr("sidebar-img", o) : $("#" + t).attr("sidebar-img", "false"), void 0 != i && "" != i ? $("#" + t).attr("sidebar-img-type", i) : $("#" + t).attr("sidebar-img-type", "img1")
            },
            ...
            HandleThemeBackground: function() {
                ...
                function() {
                    var a = e.LHeaderBackground,
                        o = e.ActiveItemBackground;
                    void 0 != a && "" != a ? $("#" + t + " .pcoded-navigation-label").attr("menu-title-theme", a) : $("#" + t + " .pcoded-navigation-label").attr("menu-title-theme", "theme1"), void 0 != o && "" != o ? $("#" + t + " .profile-notification").attr("active-item-theme", o) : $("#" + t + " .profile-notification").attr("active-item-theme", "theme1")
                }(),
                function() {
                ...
                function() {
                    var a = e.logoBackground;
                    void 0 != a && "" != a ? $("#" + t + " .navbar-logo").attr("logo-theme", a) : $("#" + t + " .navbar-logo").attr("logo-theme", "theme1")
                }()
            },
            ...
            HandleSubMenuTrigger: function() {
                function a(e) {
                    "hover" == e ? (r = e, i.off("click").off("mouseenter mouseleave").hover(function() {
                        $(this).addClass("pcoded-trigger")
                    }, function() {
                        $(this).removeClass("pcoded-trigger")
                    })) : "click" == e && (r = e, i.off("mouseenter mouseleave").off("click").on("click", function(e) {
                ...
                switch (e.SubMenuTrigger) {
                    case "hover":
                        ...
                        a(d >= 992 ? "hover" : "click"), o.resize(function() {
                            var e = o.width();
                            d != e && (e >= 992 && "hover" != r ? a("hover") : e < 992 && "click" != r && a("click"), d = e)
                        });
                        break;
                    case "click":
                        $("#" + t + " .pcoded-navbar .pcoded-hasmenu").removeClass("is-hover"), $(".pcoded-item .pcoded-submenu > li > .pcoded-submenu > li").on("click", function(e) {
            ...
            HandleMenuTrigger: function() {
                function a(e) {
                    "hover" == e ? (r = e, i.off("click").off("mouseenter mouseleave").hover(function() {
                        ...
                        $(this).removeClass("pcoded-trigger")
                    })) : "click" == e && (r = e, i.off("mouseenter mouseleave").off("click").on("click", function() {
            ...
            HandleMenuOnClick: function() {
                ...
                "vertical" === e.themelayout ? $("#mobile-collapse,#mobile-collapse1,.sidebar_toggle a, .pcoded-overlay-box,.menu-toggle a").on("click", function() {
                    ...
                    if ("desktop" == a) {
                        ...
                        var r = e.onToggleVerticalMenu.tablet,
                            n = e.defaultVerticalMenu.tablet,
                            c = $("#" + t).attr("vertical-nav-type");
                        c == n ? $("#" + t).attr("vertical-nav-type", r) : d == o && $("#" + t).attr("vertical-nav-type", n)
                    } else if ("phone" == a) {
            ...
            HandleDeviceType: function() {
                function a() {
                    ...
                    if ("vertical" === e.themelayout) {
                        ...
                        "collapsed" == $("#" + t).attr("vertical-nav-type") ? $("body").addClass("menucollapse") : $("body").removeClass("menucollapse")
    ...
    $(this).scrollTop() > 50 ? ($('.pcoded[theme-layout="vertical"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]').css("position", "fixed"), $('.pcoded[theme-layout="vertical"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]').css("top", 0), $('.pcoded[theme-layout="vertical"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]').css("height", "100%"), $('.pcoded[theme-layout="vertical"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"] .nav-list').css("height", "100%")) : ($('.pcoded[theme-layout="vertical"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]').css("position", "absolute"), $('.pcoded[theme-layout="vertical"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"]').css("top", "auto"))
}), $(window).scroll(function() {
    ...
    $(".pcoded-item > li.pcoded-trigger");
    setTimeout(function() {
        var e = $(".pcoded-item .pcoded-trigger.active, .pcoded-item .active"),
            t = e.offset();
        e.width(), $(window).height(), $(window).width();
        $(".main-menu").slimScroll({
            scrollBy: t.top - 100 + "px",
            animate: !0
        })
    }, 500)
});